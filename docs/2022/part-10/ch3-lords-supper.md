...
#### ¶5600 {#p5600}
 Each local church is encouraged to provide for the observance of the Lord’s Supper at least once each month but is required to do so at least once every three months ([¶293](/2022/part-1/ch4-constitution#p293); [¶725:6](/2022/part-2/ch4-pastors#p725-6)).
...
*(After all have partaken, let that which remains of the consecrated elements be returned to the table, and covered with the white linen cloth. Then let the minister and congregation join in praying:)*
